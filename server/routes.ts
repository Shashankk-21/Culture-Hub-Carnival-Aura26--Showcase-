...
const clubs = [
  {
    ...
    members: [
      { name: "Person X", role: "President" },
      { name: "Person Y", role: "Vice President" },
      { name: "Person I", role: "Music Director" },
      { name: "Person J", role: "Event Coordinator" },
      { name: "Person K", role: "Vocalist Lead" },
      { name: "Person L", role: "Instrumentalist Lead" }
    ],
    icon: "Music",
    memberCount: 85,
  ...
  },
  {
    ...
    members: [
      { name: "Person A", role: "President" },
      { name: "Person B", role: "Vice President" },
      { name: "Person C", role: "Choreographer" },
      { name: "Person D", role: "Contemporary Lead" },
      { name: "Person E", role: "Classical Lead" },
      { name: "Person F", role: "Hip-Hop Lead" }
    ],
    icon: "Music2",
    memberCount: 120,
  ...
  },
  {
    ...
    members: [
      { name: "Person O", role: "President" },
      { name: "Person P", role: "Vice President" },
      { name: "Person Q", role: "Director" },
      { name: "Person R", role: "Stage Manager" },
      { name: "Person S", role: "Script Writer" },
      { name: "Person T", role: "Costume Designer" }
    ],
    icon: "Theater",
    memberCount: 65,
  ...
  },
  {
    ...
    members: [
      { name: "Person S", role: "President" },
      { name: "Person T", role: "Vice President" },
      { name: "Person U", role: "Gallery Curator" },
      { name: "Person V", role: "Digital Art Lead" },
      { name: "Person W", role: "Painting Lead" },
      { name: "Person X", role: "Sculpture Lead" }
    ],
    icon: "Palette",
    memberCount: 95,
  ...
  },
  {
    ...
    members: [
      { name: "Person E", role: "President" },
      { name: "Person F", role: "Vice President" },
      { name: "Person G", role: "Editor-in-Chief" },
      { name: "Person H", role: "Poetry Lead" },
      { name: "Person I", role: "Book Club Lead" },
      { name: "Person J", role: "Events Coordinator" }
    ],
    icon: "BookOpen",
    memberCount: 55,
  ...
  },
  {
    ...
    members: [
      { name: "Person G", role: "President" },
      { name: "Person H", role: "Vice President" },
      { name: "Person I", role: "Exhibition Curator" },
      { name: "Person J", role: "Technical Lead" },
      { name: "Person K", role: "Social Media Lead" },
      { name: "Person L", role: "Workshop Coordinator" }
    ],
    icon: "Camera",
    memberCount: 75,
